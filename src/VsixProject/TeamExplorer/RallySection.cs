...
namespace RallyExtension.Extension.TeamExplorer
{
    [TeamExplorerSection("d7526377-03bd-4ee0-97ff-4e75e83cc947", TeamExplorerPageIds.PendingChanges, 34)]
    public class RallyWorkItemSection : BaseTeamExplorerSection<SectionContent>
    {
        ...
        protected override string BaseTitle { get; } = "Rally Tasks";
        ...
        private void OverwriteCheckinButton(Type viewModelType, object pageViewModel)
        {
            ...
            {
                ShowNotification("Rally Extension Fatal error: Could not find check-in command", NotificationType.Error);
                return;
            }
        ...
        private void WatchForCheckIns(Type viewModelType, object pageViewModel)
        {
            ...
            {
                ShowNotification("Rally Extension Fatal error: Could not find checkin-related event/properties", NotificationType.Error);
                return;
            }
            ...
            EventHandler checkinComplete = (s, e) =>
            {
                ...
                else
                {
                    ...
                    CheckinComment = Content.ViewModel.RemoveTaskPrefix(CheckinComment);
                }
            };
        ...
        public string CheckinComment
        {
            ...
            set
            {
                ...
                if (commentProp == null)
                {
                    ShowNotification("Rally Extension Error: Could not set Check In Comment", NotificationType.Error);
                }
                else
                {
